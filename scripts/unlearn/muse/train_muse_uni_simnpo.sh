...
delta_set=(0.0)
gamma_set=(0.5)
sigma_forget_set=(0.5 1.0 2.0 5.0 10.0)
alpha_set=(1.0)
eps_set=(0.14 0.16 0.18 0.20)
eta_set=(0.05 0.1)
                                ...
                                for alpha in "${alpha_set[@]}"; do
                                    for eps in "${eps_set[@]}"; do
                                        for eta in "${eta_set[@]}"; do
                                            ...
                                            SUFFIX="lr${lr}_b${bsz}_ga${grad_acc}_beta${beta}_delta${delta}_gamma${gamma}_sigmaF${sigma_forget}_a${alpha}_eps${eps}_eta${eta}_e${epochs}"
